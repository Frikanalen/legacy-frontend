...
export default function About() {
  return (
    <Document>
      ...
      <p>
        Foreningen skal tilrettelegge for ikke-kommersiell, allmenn deltakelse i den åpne TV-kanalen i det digitale
        bakkenettet og på andre distribusjonsplattformer (heretter kalt Frikanalen).
      </p>
      <p>
        Frikanalen er en TV-kanal der frivillige organisasjoner, livssynsorganisasjoner og andre ikke- kommersielle
        virksomheter kan få tildelt sendetid på rimelige vilkår.
      </p>
      <p>
        Målet med Frikanalen er å styrke ytringsfriheten og det deltakende demokratiet gjennom å gi flere mulighet til å
        ytre seg gjennom TV-mediet.
      </p>
      <p>
        Foreningen skal koordinere arbeidet med kanalen, drive rådgivning og kompetansehevende tiltak, stimulere
        organisasjoner og andre til å ta TV-mediet i bruk, samt drive interessepolitisk arbeid knyttet til kanalen.
      </p>
      <p>
      ...
      <p>
        ...
        fortjenestebasert/ikke-offentlig basis i Norge, i henhold til avgrensningene i lov om frivillighetsregister § 3
        og § 4.
      </p>
      ...
      <p>
        ...
        Foreningen Frikanalen på avtalt skjema/medium. Alle medlemmene er pliktige til å rette seg etter gjeldende
        vedtekter.
      </p>

      <h3>§ 3-2. Rettigheter</h3>
      ...
      <p>
        ...
        tekstreklame, logoer eller produktplassering, for tredjeparts varer eller tjenester.
      </p>
      <p>
      ...
      <p>
        Årsmøtet er Foreningen Frikanalen høyeste myndighet. Det skal holdes ordinært Årsmøte innen utgangen av 31. mars
        hvert år. Det skal kalles inn til ekstraordinært Årsmøte dersom minst 3 styremedlemmer eller 2/3 av medlemmene
        krever det.
      </p>
      ...
      <ul>
        ...
        <li>
          disponere organisasjonens inntekter i tråd med handlingsplan, budsjett og til beste for Foreningen Frikanalen
          som landsomfattende organisasjon.
        </li>
